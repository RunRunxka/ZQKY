/**
 * 移植来源：DSH-Transparent-UI-Plugin (AGPL-3.0) src/client/fluid-shader.ts
 * 原始作者：WYH66666666（DSH-Transparent-UI-Plugin，本身移植自 deepseek.com
 * join-section 流体着色器）。本文件随宿主项目按 AGPL-3.0 传播；若宿主项目
 * 将来公开分发，请注意整体 AGPL 合规或移除本文件。
 * 除本头注释外，代码与上游保持一致。
 * ============================================================================
 */
