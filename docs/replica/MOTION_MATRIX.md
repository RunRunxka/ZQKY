...
当前R-05三批（B-R05-SPACE-VISUAL v1、B-R05-EXTEND v1/v2，均 2026-09-18）已交付：公共变量层、`/space` 首页、知识库/笔记本四页、书籍/课程四页；磁贴动画见 M-space-tile，v1 见 M-kb-tabs/M-kb-actions/M-nb-indicator/M-nb-pop（M-nb-mobile-wrap 为首败修复项），v2 见 M-books-card/M-books-actions/M-courses-card；R-05 其余推广批的动画仍先核参考再实现/验收。阅读R-09上滚、显式回到底部和手机reduce行为已测，未证明全部阅读曲线；原动画状态不因文档整理升级。
